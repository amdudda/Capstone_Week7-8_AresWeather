...
class Command(BaseCommand):
    help = 'Fetches archival data from MAAS website by deleting and replacing existing data.'
...
def load_api_data(url):
    '''
    Gets data from an API via a user-supplied url
    :param url: the url to use to request API data.
    :return:
    '''
    next_page = True  # set to true to get us through first page of data...
    total_records = 0
    # counter used for debugging while loop and reporting pages of data
    counter = 0
    while next_page:  # and counter < 5:
        ...
        # end while loop
    print('Database successfully updated with %d records of data.' % total_records)
# end load_api_data
